...
int i=0;
  ...
  while (1)
  {
    ...
    if(HAL_GPIO_ReadPin(pushb_GPIO_Port, pushb_Pin)){
    	for(i=0;i<15;i++){
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : OTG_FS_PowerSwitchOn_Pin cikis_Pin */
  GPIO_InitStruct.Pin = OTG_FS_PowerSwitchOn_Pin|cikis_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
